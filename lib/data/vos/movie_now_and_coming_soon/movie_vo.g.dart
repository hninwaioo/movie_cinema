...
class MovieVOAdapter extends TypeAdapter<MovieVO> {
  ...
  MovieVO read(BinaryReader reader) {
    ...
    return MovieVO(
      ...
      fields[4] as double?,
      (fields[5] as List?)?.cast<GenresVO>(),
      fields[6] as String?,
      fields[7] as int?,
      fields[8] as String?,
      fields[9] as String?,
  ...
  void write(BinaryWriter writer, MovieVO obj) {
    writer
      ...
      ..write(obj.voteCount)
      ..writeByte(26)
      ..write(obj.isNowPlayingMovies)
      ..writeByte(27)
      ..write(obj.isComingMovies);
  }
...
MovieVO _$MovieVOFromJson(Map<String, dynamic> json) => MovieVO(
      ...
      json['isNowPlayingMovies'] as bool?,
      json['isComingMovies'] as bool?,
    );
...
Map<String, dynamic> _$MovieVOToJson(MovieVO instance) => <String, dynamic>{
      ...
      'belongs_to_collection': instance.collectionVo,
      ...
      'isNowPlayingMovies': instance.isNowPlayingMovies,
      'isComingMovies': instance.isComingMovies,
    };
