...
part of 'the_movie_cinema_api.dart';

// **************************************************************************
// RetrofitGenerator
// **************************************************************************

class _TheMovieCinemaApi implements TheMovieCinemaApi {
  _TheMovieCinemaApi(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<CreditCastResponse> getCreditCast(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CreditCastResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = CreditCastResponse.fromJson(_result.data!);
    return value;
  }
